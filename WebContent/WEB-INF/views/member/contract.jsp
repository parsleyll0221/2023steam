        ...
        <div id="content-wrapper" class="d-flex flex-column bg-custom-blue">
            ...
            <div id="content">
                ...
                <div class="container">
                	...
                	<!-- 여기 내부 부분을 작업하면 됩니다 -->
                	<div id="t3-content" class="card-body p-5 bg-custom-blue" style="padding-top:0">
                		<form class="form-horizontal" name="joinFrm" id="joinFrm" method="post">
						...
						<div class="docs-section">
							...
							<div class="well">
								...
								<div class="checkbox">
									<label for="privateApprovalFl" class="control-label"><input type="checkbox" id="privateApprovalFl" name="privateApprovalFl" value="Y" required="required">개인정보 수집 및 이용에 동의합니다.</label>
								</div>
							</div>
							<p class="text-danger"><strong>※ Stream 서비스 제공을 위해서 필요한 최소한의 개인정보이므로 동의를 해 주셔야 서비스를 이용하실 수 있습니다.</strong></p>
						</div>
                		<div class="docs-section">
							<div class="page-header">
								<h1 id="example-colors">이용약관 (필수)</h1>
							</div>
							<div class="well">
								<textarea id="agreement" class="form-control" rows="15" readonly="readonly">제1조(목적)
이 약관은 회사가 “Stream” 인터넷 사이트(이하 "Stream” 라고 합니다)를 통하여 제공하는 인터넷 관련 서비스 및 기타 정보서비스(이하 "서비스"라고 합니다)와 관련하여 회사와 회원간의 권리와 의무, 책임사항 및 회원의 서비스이용절차에 관한 사항을 규정함을 목적으로 합니다.

* 「스마트폰 등 이동통신기기 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의)
①"Stream" 란 회사가 재화 또는 용역(이하 "재화 등"이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버 몰을 운영하는 사업자의 의미로도 사용합니다.
...
① "회사"는 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호, 이메일, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자 등을 이용자가 쉽게 알 수 있도록 Stream의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
...
④ "회사"가 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 Stream의 초기화면에 그 적용일자 7일 이전부터 적용일자 전일까지 공지합니다. 
다만, 이용자에게 불리하게 약관내용을 변경하는 경우에는 최소한 30일 이상의 사전 유예기간을 두고 공지합니다. 이 경우 "회사"는 개정 전 내용과 개정 후 내용을 명확하게 비교하여 이용자가 알기 쉽도록 표시합니다.

⑤ "회사"가 약관을 개정할 경우에는 그 개정약관은 그 적용일자 이후에 체결되는 계약에만 적용되고 그 이전에 이미 체결된 계약에 대해서는 개정전의 약관조항이 그대로 적용됩니다. 다만 이미 계약을 체결한 이용자가 개정약관 조항의 적용을 받기를 원하는 뜻을 제3항에 의한 개정약관의 공지 기간 내에 “Stream"에 송신하여 "Stream"의 동의를 받은 경우에는 개정약관 조항이 적용됩니다.
...
2. "Stream"를 이용하여 구입한 재화 등의 대금, 기타 "Stream"이용에 관련하여 회원이 부담하는 채무를 기일에 지급하지 않는 경우
3. 다른 사람의 "Stream" 이용을 방해하거나 그 정보를 도용하는 등 전자상거래 질서를 위협하는 경우
4. "Stream"를 이용하여 법령 또는 이 약관이 금지하거나 공서양속에 반하는 행위를 하는 경우
...
② "회사"는 불특정다수 회원에 대한 통지의 경우 1주일이상 "Stream" 게시판에 게시함으로써 개별 통지에 갈음할 수 있습니다. 다만, 회원 본인의 거래와 관련하여 중대한 영향을 미치는 사항에 대하여는 개별통지를 합니다.

제9조(구매신청)
"Stream" 이용자는 "Stream"상에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며, "회사"는 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야 합니다.  단, 회원인 경우 제2호 내지 제4호의 적용을 제외할 수 있습니다.
1. 재화등의 검색 및 선택
2. 닉네임, 전자우편주소 입력
3. 약관내용, 청약 철회권이 제한되는 서비스의 비용부담과 관련한 내용에 대한 확인
4. 이 약관에 동의하고 위 3.호의 사항을 확인하거나 거부하는 표시(예, 마우스 클릭)
5. 재화 등의 구매신청 및 이에 관한 확인 또는 "Stream"의 확인에 대한 동의
6. 결제방법의 선택
...
3. 기타 구매신청에 승낙하는 것이 "Stream" 기술상 현저히 지장이 있다고 판단하는 경우
...
2. 타인의 정보 도용
3. "Stream"에 게시된 정보의 변경
4. "Stream"가 정한 정보 이외의 정보(컴퓨터 프로그램 등) 등의 송신 또는 게시
5. "Stream" 기타 제3자의 저작권 등 지적재산권에 대한 침해
6. "Stream" 기타 제3자의 명예를 손상시키거나 업무를 방해하는 행위
7. 외설 또는 폭력적인 메시지, 화상, 음성, 기타 공서양속에 반하는 정보를 Stream에 공개 또는 게시하는 행위
...
제24조(게시판의 이용)
가. 게시판 이용 원칙 
1) 회사는 Stream 내에서 회원들이 지식을 공유할 수 있는 게시판을 운영하거나, 일정한 자격을 가진 회원들이 이를 운영할 수 있도록 할 수 있습니다. 
2) 게시물로 인해 발생하는 저작권 침해를 비롯한 민,형사상의 모든 책임은 당해 게시물의 게시자에게 있으며, 회사는 이에 대해 책임지지 않습니다. 
나. 게시물의 저작권 
1) Stream의 게시판에 회원이 등록한 게시물의 저작권은 제3자의 권리를 침해하지 않는 한, 등록한 회원에게 속합니다. 
...
본 약관은 2023년 11월 01일 부터 적용됩니다.
</textarea>
								
								<div class="checkbox">
								  <label for="agreementInfoFl" class="control-label"><input type="checkbox" id="agreementInfoFl" name="agreementInfoFl" value="Y" required="required">이용약관에 동의합니다.</label>
								</div>
							</div>
						</div>
						<div>
							<button class="btn btn-primary btn-block" id="btnMemberSubmit">다음</button>
						</div>	
                		</form>
                	</div>
