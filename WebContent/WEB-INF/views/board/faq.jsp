                ...
                <div class="container">
                    ...
                    <div class="d-flex justify-content-center">
	                    <div class="input-group mb-3 mt-5 search-w-500">
						  <input id="searchTxt" name="searchTxt" type="text" class="form-control rounded-3 bg-dark border-0 text-light" placeholder="검색어를 입력하세요." aria-label="search-qna" aria-describedby="button-addon2" onkeydown="handleEnterKey(event)">
