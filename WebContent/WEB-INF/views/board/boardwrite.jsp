...
<!--               	<form method="post" enctype="multipart/form-data" action="/board/boardwrite"> -->
              	<form method="post" action="/board/boardwrite">
						...
						<div class="mb-3 mt-5">
					  		...
					  		<h5 class="text-light">${b.nickname}</h5> <!--${member} -->
						</div>
					...
					<div class="mb-3">
					  ...
					  <textarea name="boardContent" class="form-control" id="exampleFormControlTextarea1" rows="7" placeholder="문의내용을 입력하세요."></textarea>
					</div>
