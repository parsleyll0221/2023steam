            ...
            <div id="content">
                ...
                <div class="container">
						...
						<div class="mt-3 nav-item dropdown no-arrow px-0 py-0 d-flex justify-content-between align-items-center ">
							<div>
	                            ...
	                            <img class="px-0 py-0 mr-2 col-1 img-profile rounded-circle "
	                               ...
	                               <p class="pr-2 d-none d-lg-inline text-light border-right border-secondary border-4">${member.memberNickname }</p>
                	...
                	<h1 class="display-4 mr-3"><b><strong>A</strong></b></h1>
                		<div class="">
                    		<h3 class="board-title"><strong>${board.boardTitle}에 관한 답변</strong></h3>
                    		<h5>관리자 답변</h5>
                		</div>
                	</div>
						<c:choose>
							<c:when test="${board.isAnswer == '1'}">
								<div class="mt-3 nav-item dropdown no-arrow px-0 py-0 d-flex justify-content-between align-items-center ">
									<div>
			                            <a class="nav-link dropdown-toggle px-0 py-0 " href="javascript:;" id="userDropdown"
			                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></a>
			                            <img class="px-0 py-0 mr-2 col-1 img-profile rounded-circle "
			                           	...
			                           	<span class="d-none d-lg-inline text-gray-600">${board.answerDate}</span>
		                         	</div>
		                         	<div class="d-flex align-items-center">
									  <div class="position-relative">
									    <a class="fas fa-ellipsis-v ml-4 tooltip-button" style="color:#2970ff"></a>
									    <div class="position-absolute tooltip bg-dark text-light rounded" style="display: none;">
									        <button type="button"  class="bg-dark text-light edit-button">수정</button>
									        <button type="button" class="bg-dark text-light delete-button">삭제</button>
									    </div>
									</div>
	...
	<script type="text/javascript">
	  ...
	  tooltipButtons.forEach((button, index) => {
	    ...
	    editButtons[index].addEventListener('click', () => {
	      ...
	      window.location.href = '/board/boardmodify?boardNo=${board.boardNo}';
	    });
	  });
	</script>
</body>
